...
![janitor::clean_names](https://cdn.myportfolio.com/45214904-6a61-4e23-98d6-b140f8654a40/79a12c01-0cc1-4643-b1e7-8ce8cafc947b.png?h=4629f141b6a3b4889b5fca17d1aee45a)
...
查看列名的函数： - colnames(): 获取或设置数据框的列名称。 - names(): 获取或设置对象的名称属性，适用于多种对象类型，包括数据框。 - glimpse(): 来自 dplyr 包，提供数据框的结构概览，包括列名称和数据类型。 - str(): R 的基础函数，显示对象的结构信息，包括列名称和数据类型。

处理第一行数据作为列名的函数： - row_to_names(): 来自 janitor 包，将指定行的数据提升为列名称，并删除该行。
