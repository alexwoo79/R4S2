...
```{r}
DT::datatable(total_contact,filter = 'top')
```
...
department_table <- department_contact_T |>
  ...
  summarise(Total = round(sum(Value, na.rm = T)/10000,2))
DT::datatable(department_table)
```
